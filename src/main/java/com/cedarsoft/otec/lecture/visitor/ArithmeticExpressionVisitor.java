...
public interface ArithmeticExpressionVisitor {
  void visitCompositeOperand( CompositeOperand compositeOperand );

  void visitNumericOperand( NumericOperand numericOperand );

  void visitSumOperand( SumOperand sumOperand );
}
