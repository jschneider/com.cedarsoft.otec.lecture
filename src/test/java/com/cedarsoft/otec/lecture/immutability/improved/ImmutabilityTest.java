...
public class ImmutabilityTest {
  ...
  public void testName( ) throws Exception {
    ...
    shoppingCart.add( bgb, 1 );

    print( shoppingCart );
    //    shoppingCart.getEntries().put( erbarmen, 3 );
    shoppingCart.add( erbarmen, 3 );
    print( shoppingCart );
  ...
  private void superEvil( ) {
    //Der folgende Code lässt sich nicht (mehr) kompilieren
  ...
  private void printEvil( ShoppingCart shoppingCart ) {
    ...
    try {
      shoppingCart.getEntries( ).put( erbarmen, oldAmount + 1 ); //UnsupportedOperationException
